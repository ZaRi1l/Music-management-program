...
namespace 음원_관리_프로그램
{
    internal class PlaylistClass
    {
        ...
        DataTable PLAYLISTTable;// DataTable 객체입니다.
        ...
        public DataTable PlaylistTable
        {
            get { return PLAYLISTTable; }
            set { PLAYLISTTable = value; }
        }
        ...
        public void DB_Open()
        {
            try
            {
                ...
                string commandString = "select * from PLAYLIST";
