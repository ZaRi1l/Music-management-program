...
namespace 음원_관리_프로그램
{
    internal class TrackAsClass
    {
        ...
        DataTable TRACKASTable;// DataTable 객체입니다.
        ...
        public DataTable TrackAsTable
        {
            get { return TRACKASTable; }
            set { TRACKASTable = value; }
        }
        ...
        public void DB_Open()
        {
            try
            {
                ...
                string commandString = "select track_no 노래번호, track_name 제목, genre 장르, play_count 조회수, like_count 좋아요, price 가격, rel_date 발행일, id 가수 from TRACK";       // 노래만
