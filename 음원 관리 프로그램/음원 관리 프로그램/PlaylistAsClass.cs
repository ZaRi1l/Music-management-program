...
{
    internal class PlaylistAsClass
    {
        ...
        DataTable PLAYLISTASTable;// DataTable 객체입니다.
        ...
        public DataTable PlaylistAsTable
        {
            get { return PLAYLISTASTable; }
            set { PLAYLISTASTable = value; }
        }
        ...
        public void DB_Open()
        {
            try
            {
                ...
                string commandString = "select id 구매자, track_no 노래번호, track_name 노래제목, genre 장르 from PLAYLIST";

                DBAdapter = new OracleDataAdapter(commandString, connectionString);

                MyCommandBuilder = new OracleCommandBuilder(DBAdapter);

                DS = new DataSet(); //PLAYLIST 테이블
