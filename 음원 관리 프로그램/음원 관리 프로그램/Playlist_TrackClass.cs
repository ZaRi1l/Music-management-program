...
{
    internal class Playlist_TrackClass
    {
        ...
        DataTable PLAYLIST_TRACKTable;// DataTable 객체입니다.
        ...
        public DataTable Playlist_TrackTable
        {
            get { return PLAYLIST_TRACKTable; }
            set { PLAYLIST_TRACKTable = value; }
        }
        ...
        public void DB_Open()
        {
            try
            {
                ...
                string commandString = "select * from PLAYLIST_TRACK";

                DBAdapter = new OracleDataAdapter(commandString, connectionString);

                MyCommandBuilder = new OracleCommandBuilder(DBAdapter);

                DS = new DataSet(); //PLAYLIST_TRACK 테이블
        ...
        public void DB_ObjCreate()
        {
            try
            {
                PLAYLIST_TRACKTable = new DataTable();
            }
