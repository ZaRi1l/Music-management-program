...
{
    internal class User_ProfileClass
    {
        ...
        DataTable USER_PROFILETable;// DataTable 객체입니다.
        ...
        public DataTable User_ProfileTable
        {
            get { return USER_PROFILETable; }
            set { USER_PROFILETable = value; }
        }
        ...
        public void DB_Open()
        {
            try
            {
                ...
                string commandString = "select * from USER_PROFILE";

                DBAdapter = new OracleDataAdapter(commandString, connectionString);

                MyCommandBuilder = new OracleCommandBuilder(DBAdapter);

                DS = new DataSet(); //USER_PROFILE 테이블
        ...
        public void DB_ObjCreate()
        {
            try
            {
                USER_PROFILETable = new DataTable();
            }
